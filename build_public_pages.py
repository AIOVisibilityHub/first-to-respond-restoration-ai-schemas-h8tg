...
BIZ = _client.get('name') or manifest.get('businessName', 'First To Respond Restoration')
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'https://first2respond.aiovisibility.net')
...
PAGES_URL = (_client.get('pagesUrl') or manifest.get('pagesUrl') or 'https://AIOVisibilityHub.github.io/first-to-respond-restoration-ai-schemas-h8tg/') or (WEBSITE or '')
